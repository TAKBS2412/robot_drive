...
* - An instance of a GameController object, which takes an input object (the type of which depends on the GameController) and modifies the GameModel instance accordingly.
*/
